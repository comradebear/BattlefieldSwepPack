...
if CLIENT then
	...
	SWEP.IronsightPos = Vector(-2.5, 0, 0.68)
...
SWEP.Sounds = {
	base_ready = {
		{time = 0.6, sound = "ROLEPLAY_M4A1_BOLTBACK"},
		{time = 1, sound = "ROLEPLAY_M4A1_BOLTRELEASE"}
	},

	base_reload = {
		{time = 0.35, sound = "ROLEPLAY_M4A1_MAGRELEASE"},
		{time = 0.45, sound = "ROLEPLAY_M4A1_MAGOUT"},
		{time = 2, sound = "ROLEPLAY_M4A1_MAGIN"},
		{time = 2.5, sound = "ROLEPLAY_M4A1_HIT"}
	},
	...
	base_reloadempty = {
		...
		{time = 0.45, sound = "ROLEPLAY_M4A1_MAGOUT"},
		{time = 2, sound = "ROLEPLAY_M4A1_MAGIN"},
		{time = 2.6, sound = "ROLEPLAY_M4A1_HIT"},
		{time = 3.4, sound = "ROLEPLAY_M4A1_BOLTRELEASE"}
	}
}
...
SWEP.UseHands = true
SWEP.ViewModel		= "models/roleplay_weapons/v_models/m4a1.mdl"
SWEP.WorldModel		= "models/roleplay_weapons/w_models/m4a1.mdl"
...
SWEP.FireSound = "ROLEPLAY_M4A1_FIRE"
